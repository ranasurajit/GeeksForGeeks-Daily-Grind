class Solution {
    ...
    public boolean canServe(int[] arr) {
        int n = arr.length;
        if (arr[0] > 5) {
            // assuming I don't have any denominations initially
            return false;
        }
        // In the below array we can store denominations of 5, 10 and 20 respectively
        int[] denominations = { 0, 0, 0 }; // SC: O(3)
        int i = 0;
